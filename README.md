# qixi这个是一个七夕主题的一个小动画，主要运用了css3+h5+js,包括3个页面。第一个页面实现：太阳的运动，云彩的飘动，小男孩的走动；第二个页面：商店开关门，灯变亮和变暗，小男孩取花，小鸟飞过；第三个页面：星星闪烁，水波流动，上桥，转身，飘花，文字展现。主要涉及到的知识点有：1，采用js+百分比布局解决自适应分辨率的问题，通过合成“雪碧图”解决图片加载与资源占用的问题
